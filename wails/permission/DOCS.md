...
- [type PermissionPlugin](<#PermissionPlugin>)
  ...
  - [func \(p \*PermissionPlugin\) Init\(app \*wails.Application\) error](<#PermissionPlugin.Init>)
...
### func \(\*PermissionPlugin\) [Check](<https://github.com/its-ernest/wails-mobile/blob/main/wails/permission/permission.go#L54>)
...
### func \(\*PermissionPlugin\) [Request](<https://github.com/its-ernest/wails-mobile/blob/main/wails/permission/permission.go#L66>)
