...
```go
import (
    "github.com/its-ernest/wails-mobile/plugins/devicestate"
...
This plugin is Android-only. It uses native Android platform APIs through the Wails Mobile bridge and does not require manual JNI implementation.
