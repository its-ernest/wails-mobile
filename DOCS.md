...
Package wails provides the core runtime for Wails Mobile applications. It manages the application lifecycle, service binding, and the bridge between Go and the native mobile platform.
...
### func [NewApplication](<https://github.com/its-ernest/wails-mobile/blob/main/wails/app.go#L48>)
...
### func \(\*Application\) [InvokeCall](<https://github.com/its-ernest/wails-mobile/blob/main/wails/invoke.go#L10>)
...
### func \(\*Application\) [InvokeNativeCall](<https://github.com/its-ernest/wails-mobile/blob/main/wails/app.go#L95>)
...
### func \(\*Application\) [NewWindow](<https://github.com/its-ernest/wails-mobile/blob/main/wails/app.go#L60>)
...
### func \(\*Application\) [ReadAsset](<https://github.com/its-ernest/wails-mobile/blob/main/wails/assetserver.go#L18>)
...
### func \(\*Application\) [RegisterNativeMethod](<https://github.com/its-ernest/wails-mobile/blob/main/wails/app.go#L87>)
...
### func \(\*Application\) [Run](<https://github.com/its-ernest/wails-mobile/blob/main/wails/app.go#L66>)
...
## type [AssetResponse](<https://github.com/its-ernest/wails-mobile/blob/main/wails/assetserver.go#L11-L15>)
...
<a name="EventBus"></a>
## type [EventBus](<https://github.com/its-ernest/wails-mobile/blob/main/wails/eventbus.go#L16-L20>)
...
### func [NewEventBus](<https://github.com/its-ernest/wails-mobile/blob/main/wails/eventbus.go#L22>)
...
### func \(\*EventBus\) [Emit](<https://github.com/its-ernest/wails-mobile/blob/main/wails/eventbus.go#L37>)
...
### func \(\*EventBus\) [On](<https://github.com/its-ernest/wails-mobile/blob/main/wails/eventbus.go#L30>)
...
### func \(\*EventBus\) [PollNativeEvent](<https://github.com/its-ernest/wails-mobile/blob/main/wails/eventbus.go#L53>)
...
## type [EventCallback](<https://github.com/its-ernest/wails-mobile/blob/main/wails/eventbus.go#L14>)
...
<a name="WailsEvent"></a>
## type [WailsEvent](<https://github.com/its-ernest/wails-mobile/blob/main/wails/eventbus.go#L9-L12>)
...
<a name="Window"></a>
## type [Window](<https://github.com/its-ernest/wails-mobile/blob/main/wails/app.go#L30-L32>)
...
## type [WindowOptions](<https://github.com/its-ernest/wails-mobile/blob/main/wails/app.go#L25-L27>)
